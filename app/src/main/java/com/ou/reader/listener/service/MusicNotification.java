...
import com.ou.reader.listener.activity.PlayActivity;
import com.ou.reader.listener.bean.Song;
import com.ou.reader.listener.utils.ListenSettingManager;
...
public class MusicNotification {
    ...
    private static void setUp() {
        ...
        builder.setStyle(
                ...
                .setContentIntent(PendingIntent.getActivity(musicService, REQ_CODE,
                        new Intent(musicService, PlayActivity.class), PendingIntent.FLAG_CANCEL_CURRENT))
    ...
    private static void update() {
        boolean notify = ListenSettingManager.getInstance().getSetting(ListenSettingManager.SETTING_NOTIFY, true);
        if (!notify) {
            return;
        }
        if (builder == null) {
...
//        Glide.with(ReaderApplication.getsInstance()
