...
public class BitmapUtils {
    ...
    public static int dp2px(int dp) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp,
                ReaderApplication.getsInstance().getResources().getDisplayMetrics());
    }
    ...
    public static int px2dp(float pxValue) {
        final float scale = ReaderApplication.getsInstance().getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(float spValue) {
        final float fontScale = ReaderApplication.getsInstance().getResources().getDisplayMetrics().scaledDensity;
